...
showStatus("<b>填挖方分析</b><br>核心概念: cut and fill volume estimation<br>核心 API: grid sampling + volume integration");

Sandcastle.addDefaultToolbarButton("演示 填挖方分析", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>填挖方分析 - 运行中</b><br>核心: cut and fill volume estimation");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "填挖方分析", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
