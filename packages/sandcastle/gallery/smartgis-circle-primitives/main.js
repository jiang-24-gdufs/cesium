...
showStatus("<b>环形特效</b><br>核心概念: expanding ring effect with custom material<br>核心 API: EllipseGeometry + animation");

Sandcastle.addDefaultToolbarButton("演示 环形特效", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>环形特效 - 运行中</b><br>核心: expanding ring effect with custom material");
  ...
  showStatus("<b>环形特效</b><br>半径: 2000m");
