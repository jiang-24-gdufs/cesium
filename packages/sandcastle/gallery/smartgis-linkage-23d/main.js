...
showStatus("<b>二三维联动</b><br>核心概念: 2D-3D camera sync<br>核心 API: SceneMode + camera sync");

Sandcastle.addDefaultToolbarButton("演示 二三维联动", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>二三维联动 - 运行中</b><br>核心: 2D-3D camera sync");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "二三维联动", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
