...
showStatus("<b>水体效果</b><br>难度: D3<br>核心: volumetric water rendering<br>API: custom shader + depth");


Sandcastle.addDefaultToolbarButton("演示 水体效果", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "水体效果", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>水体效果 - 运行中</b>");
});
