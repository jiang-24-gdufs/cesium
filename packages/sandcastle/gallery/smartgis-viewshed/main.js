...
showStatus("<b>可视域分析</b><br>核心概念: viewshed analysis<br>核心 API: frustum + depth");

Sandcastle.addDefaultToolbarButton("演示 可视域分析", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>可视域分析 - 运行中</b><br>核心: viewshed analysis");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "可视域分析", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
