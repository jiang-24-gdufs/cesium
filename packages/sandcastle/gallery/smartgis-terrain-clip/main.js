...
showStatus("<b>地形开挖</b><br>核心概念: terrain excavation<br>核心 API: ClippingPolygon");

Sandcastle.addDefaultToolbarButton("演示 地形开挖", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>地形开挖 - 运行中</b><br>核心: terrain excavation");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "地形开挖", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
