...
showStatus("<b>淹没分析</b><br>核心概念: flood simulation<br>核心 API: height threshold");

Sandcastle.addDefaultToolbarButton("演示 淹没分析", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>淹没分析 - 运行中</b><br>核心: flood simulation");
