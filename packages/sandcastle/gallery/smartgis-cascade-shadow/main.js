...
showStatus("<b>级联阴影贴图</b><br>难度: D3<br>核心: cascaded shadow maps<br>API: ShadowMap");


Sandcastle.addDefaultToolbarButton("演示 级联阴影贴图", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "级联阴影贴图", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>级联阴影贴图 - 运行中</b>");
});
