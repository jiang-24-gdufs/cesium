...
showStatus("<b>立体分屏</b><br>难度: D3<br>核心: stereo rendering<br>API: dual camera + viewport");


Sandcastle.addDefaultToolbarButton("演示 立体分屏", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "立体分屏", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>立体分屏 - 运行中</b>");
});
