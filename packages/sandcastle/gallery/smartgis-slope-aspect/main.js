...
showStatus("<b>坡度坡向分析</b><br>核心概念: slope & aspect from normals<br>核心 API: terrain normals + color mapping");

Sandcastle.addDefaultToolbarButton("演示 坡度坡向分析", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>坡度坡向分析 - 运行中</b><br>核心: slope & aspect from normals");
  ...
  showStatus("<b>坡度坡向分析</b><br>等高线间距: 100m<br>颜色: 黄色");
