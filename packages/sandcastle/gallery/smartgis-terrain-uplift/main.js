...
showStatus("<b>地形抬升</b><br>核心概念: terrain uplift effect<br>核心 API: height offset");

Sandcastle.addDefaultToolbarButton("演示 地形抬升", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>地形抬升 - 运行中</b><br>核心: terrain uplift effect");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "地形抬升", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
