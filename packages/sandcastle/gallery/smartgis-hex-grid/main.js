...
showStatus("<b>六边形网格</b><br>难度: D3<br>核心: hexagonal discretization<br>API: Primitive + GeometryInstance");


Sandcastle.addDefaultToolbarButton("演示 六边形网格", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "六边形网格", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>六边形网格 - 运行中</b>");
});
