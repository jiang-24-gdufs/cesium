...
showStatus("<b>日照分析</b><br>难度: D3<br>核心: sun position + shadow<br>API: ShadowMap + Sun");


Sandcastle.addDefaultToolbarButton("演示 日照分析", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "日照分析", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>日照分析 - 运行中</b>");
});
