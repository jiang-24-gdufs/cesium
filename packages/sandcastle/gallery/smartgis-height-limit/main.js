...
showStatus("<b>控高分析</b><br>难度: D3<br>核心: height limit check<br>API: height comparison");


Sandcastle.addDefaultToolbarButton("演示 控高分析", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "控高分析", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>控高分析 - 运行中</b>");
});
