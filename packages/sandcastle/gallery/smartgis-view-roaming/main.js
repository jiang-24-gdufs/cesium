...
showStatus("<b>视点漫游</b><br>核心概念: viewpoint auto-roaming<br>核心 API: Camera.flyTo sequence");

Sandcastle.addDefaultToolbarButton("演示 视点漫游", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>视点漫游 - 运行中</b><br>核心: viewpoint auto-roaming");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "视点漫游", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
