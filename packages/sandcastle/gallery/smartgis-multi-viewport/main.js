...
showStatus("<b>分屏对比</b><br>核心概念: multi-viewport comparison<br>核心 API: multiple viewers");

Sandcastle.addDefaultToolbarButton("演示 分屏对比", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>分屏对比 - 运行中</b><br>核心: multi-viewport comparison");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "分屏对比", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
