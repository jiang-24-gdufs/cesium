...
showStatus("<b>建筑颜色渐变</b><br>难度: D3<br>核心: height-based coloring<br>API: Cesium3DTileStyle + CustomShader");


Sandcastle.addDefaultToolbarButton("演示 建筑颜色渐变", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "建筑颜色渐变", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>建筑颜色渐变 - 运行中</b>");
});
