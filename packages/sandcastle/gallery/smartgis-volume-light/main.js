...
showStatus("<b>体积光</b><br>难度: D3<br>核心: volumetric light rays<br>API: PostProcessStage + depth");


Sandcastle.addDefaultToolbarButton("演示 体积光", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "体积光", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>体积光 - 运行中</b>");
});
