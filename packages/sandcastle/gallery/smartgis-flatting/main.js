...
showStatus("<b>倾斜压平</b><br>核心概念: tileset flattening<br>核心 API: ClippingPlane on tileset");

Sandcastle.addDefaultToolbarButton("演示 倾斜压平", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>倾斜压平 - 运行中</b><br>核心: tileset flattening");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "倾斜压平", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
