...
showStatus("<b>Entity 淹没</b><br>核心概念: entity-based flood<br>核心 API: CallbackProperty height");

Sandcastle.addDefaultToolbarButton("演示 Entity 淹没", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>Entity 淹没 - 运行中</b><br>核心: entity-based flood");
...
Sandcastle.addToolbarButton("重置", function () {
  ...
  showStatus("<b>Entity 淹没</b><br>已重置");
});
