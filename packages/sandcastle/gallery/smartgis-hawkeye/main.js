...
showStatus("<b>鹰眼地图</b><br>核心概念: overview/hawkeye mini-map<br>核心 API: second canvas + camera sync");

Sandcastle.addDefaultToolbarButton("演示 鹰眼地图", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>鹰眼地图 - 运行中</b><br>核心: overview/hawkeye mini-map");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "鹰眼地图", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
