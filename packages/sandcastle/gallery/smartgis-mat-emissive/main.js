...
showStatus("<b>KHR_materials_emissive_strength</b><br>难度: D4<br>核心: emissive strength<br>API: CustomShader + emission");
...
Sandcastle.addDefaultToolbarButton("加载模型", function () {
  ...
  showStatus("<b>KHR_materials_emissive_strength</b><br>模型已加载<br>材质/编辑功能需 CustomShader 配置");
});
