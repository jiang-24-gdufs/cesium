...
showStatus("<b>立方体截图</b><br>难度: D3<br>核心: cubemap capture<br>API: Scene.render + framebuffer");


Sandcastle.addDefaultToolbarButton("演示 立方体截图", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "立方体截图", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>立方体截图 - 运行中</b>");
});
