...
showStatus("<b>体积云</b><br>难度: D3<br>核心: ray marching + noise<br>API: PostProcessStage");


Sandcastle.addDefaultToolbarButton("演示 体积云", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "体积云", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>体积云 - 运行中</b>");
});
