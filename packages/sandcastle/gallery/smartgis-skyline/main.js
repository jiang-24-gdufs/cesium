...
showStatus("<b>天际线分析</b><br>难度: D3<br>核心: skyline edge detection<br>API: PostProcessStage + depth");


Sandcastle.addDefaultToolbarButton("演示 天际线分析", function () {
  ...
  viewer.entities.add({
    ...
    label: { text: "天际线分析", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
  showStatus("<b>天际线分析 - 运行中</b>");
});
