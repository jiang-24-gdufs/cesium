...
showStatus("<b>景深特效</b><br>核心概念: depth of field post-processing<br>核心 API: depth texture + blur");

Sandcastle.addDefaultToolbarButton("演示 景深特效", function () {
  viewer.entities.removeAll();
  activeEntities = [];
  showStatus("<b>景深特效 - 运行中</b><br>核心: depth of field post-processing");
  ...
  const e = viewer.entities.add({
    ...
    label: { text: "景深特效", font: "14px sans-serif", showBackground: true, disableDepthTestDistance: Number.POSITIVE_INFINITY },
  });
